export const Resources = {
  ...
  earn: {
    ...
    apiStatus: {
      loading: 'Завантажуємо дані з бірж…',
      error:
        'Не вдалося отримати пропозиції з API. Перевірте підключення до бекенду або спробуйте пізніше.',
      warningsTitle: 'Частину даних показуємо з кешу',
      warningsDescription:
        'Не вдалося отримати відповіді від: {exchanges}. Підставили останні збережені значення.'
    },
    ...
    table: {
      ...
      datasetNote:
        'Дані синхронізуються через бекенд. Якщо API недоступне, показуємо кешовані значення.',
    ...
    stakingHighlights: {
      title: 'Фіксований стейкінг',
      description:
        'Оновлювана добірка пропозицій із фіксованим або гнучким періодом блокування. Вибирайте біржу та диверсифікуйте ризики.',
      empty: 'Наразі немає доступних програм.'
    },
    products: [
      {
        id: 'bnb-flex',
  ...
  launchpool: {
    ...
    apiStatus: {
      loading: 'Оновлюємо launchpool кампанії…',
      error: 'Не вдалося підключитись до API launchpool. Спробуйте перезавантажити сторінку.',
      warningsTitle: 'Деякі біржі недоступні',
      warningsDescription:
        'Не отримали відповіді від: {exchanges}. Відображаємо кешовані кампанії.'
    },
    meta: {
      lastUpdatedPrefix: 'Оновлено: '
    },
